...
export class AppService {
  private REST_API_SERVER_SECURE = 'https://api-am.cocimexanpilot.org/api/v1/missingpersondocument';
  private REST_API_SERVER_UNSECURE = 'https://api-am.cocimexanpilot.org/api/v1/missingpersondocument'
